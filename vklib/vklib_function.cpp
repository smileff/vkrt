...
bool VKCreateSwapchainRenderPass(VkDevice device, VkFormat format, VkAllocationCallbacks* allocator, VkRenderPass* renderPass)
{
	...
	if (!VKSucceed(vkCreateRenderPass(device, &renderPassCInfo, allocator, renderPass))) {
		return false;
	}
